...
public class Storage {
    ...
    public Storage(OfflinePlayer offlinePlayer) {
        ...
        this.config = new Config("data/storages/" + offlinePlayer.getUniqueId() + "/");
    ...
    public Storage(OfflinePlayer offlinePlayer, int index) {
        this.offlinePlayer = offlinePlayer;
        this.config = new Config("data/storages/" + offlinePlayer.getUniqueId() + "/" + index);
        this.config.setPlugin(SkyExcelNetworkMain.getPlugin());
        gui = new GUI(config);
        this.index = index;
    }
    ...
    public void setIndex(Player player, ItemStack item) {
        ...
        Config newConfig = new Config("data/storages/" + offlinePlayer.getUniqueId() + "/" + index);
