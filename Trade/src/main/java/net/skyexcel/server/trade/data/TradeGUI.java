...
import net.skyexcel.server.trade.packet.InventoryUpdate;
...
public class TradeGUI {
    ...
    private void updateTitle(String title) {
        InventoryUpdate.updateInventory(SkyExcelNetwork.plugin, player, title);
        InventoryUpdate.updateInventory(SkyExcelNetwork.plugin, target, title);
    }
